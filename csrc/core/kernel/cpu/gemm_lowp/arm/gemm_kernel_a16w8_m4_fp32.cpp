 ...
 * @file    gemm_kernel_a16w8_m4_fp32.cpp
 */
...
#define LABEL_SKIP_PRF_1 "6"
  ...
  asm volatile(
      ...
      /* weight u8->bf16 */
      ASM_BLOCK_WEIGHT_U8_TO_BF16(/* SRC1, SRC2             */ z16, z20, 
                                  /* DST1, DST2, DST3, DST4 */ z16, z17, z18, z19,
                                  /* TMP1, TMP2, TMP3, TMP4 */ z16, z17, z18, z19,
                                  /* TMP5, TMP6, TMP7, TMP8 */ z20, z21, z22, z23,
                                  /* SC1,  SC2,  SC3,  SC4  */ z4, z5, z6, z7, 
                                  /* ZP1,  ZP2,  ZP3,  ZP4  */ z8, z9, z10, z11)
