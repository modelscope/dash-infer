 ...
 * @file    gemm_kernel_a16w8_m8_fp32.cpp
 */
...
#include "gemm_microkernel_macro_m8.h"
...
#define ASM_BLOCK_BFMMLA                           \
      "bfmmla  z0.s, z16.h, z20.h             \n"  \
      "bfmmla  z1.s, z16.h, z22.h             \n"  \
      "bfmmla  z2.s, z18.h, z20.h             \n"  \
      "bfmmla  z3.s, z18.h, z22.h             \n"  \
      "bfmmla  z4.s, z24.h, z20.h             \n"  \
      "bfmmla  z5.s, z24.h, z22.h             \n"  \
      "bfmmla  z6.s, z26.h, z20.h             \n"  \
      "bfmmla  z7.s, z26.h, z22.h             \n"  \
                                                   \
      "bfmmla  z0.s, z17.h, z21.h             \n"  \
      "bfmmla  z1.s, z17.h, z23.h             \n"  \
      "bfmmla  z2.s, z19.h, z21.h             \n"  \
      "bfmmla  z3.s, z19.h, z23.h             \n"  \
      "bfmmla  z4.s, z25.h, z21.h             \n"  \
      "bfmmla  z5.s, z25.h, z23.h             \n"  \
      "bfmmla  z6.s, z27.h, z21.h             \n"  \
      "bfmmla  z7.s, z27.h, z23.h             \n"
// clang-format on
...
#define LABEL_SKIP_PRF_2 "8"
  ...
  asm volatile(
      ...
      " " LABEL_FOR_LOOP_K ":\n"
      ASM_BLOCK_UPDATE_DQ_PARAM(/* SRC1, SRC2 */ z14, z15,
                                /* SC1, SC2, SC3, SC4 */ z8,  z9,  z10, z11,
                                /* ZP1, ZP2, ZP3, ZP4 */ z12, z13, z14, z15)

      /* load bf16 input - part 1 */
      "mov     x4,    x0                           \n"
      "whilelt p5.h,  x4,   %[K_MAX]               \n" // compare k and K_MAX
      "add     x4,    x0,   #8                     \n"
      "whilelt p4.h,  x4,   %[K_MAX]               \n"

      "ld1h    z16.h, p5/z, [%[a_bf16_ptr1], #0, MUL VL] \n"
      "ld1h    z17.h, p4/z, [%[a_bf16_ptr1], #1, MUL VL] \n"
      "ld1h    z18.h, p5/z, [%[a_bf16_ptr2], #0, MUL VL] \n"
      "ld1h    z19.h, p4/z, [%[a_bf16_ptr2], #1, MUL VL] \n"
      ...
      "ld1b    z20.b, p3/z,   [%[b_u8_ptr1]]     \n"
      "ld1b    z24.b, p3/z,   [%[b_u8_ptr2]]     \n"
      ...
      /* weight u8->bf16 */
      ASM_BLOCK_WEIGHT_U8_TO_BF16(/* SRC1, SRC2             */ z20, z24,
                                  /* DST1, DST2, DST3, DST4 */ z20, z21, z22, z23,
                                  /* TMP1, TMP2, TMP3, TMP4 */ z20, z21, z22, z23,
                                  /* TMP5, TMP6, TMP7, TMP8 */ z24, z25, z26, z27,
                                  /* SC1,  SC2,  SC3,  SC4  */ z8,  z9,  z10, z11,
                                  /* ZP1,  ZP2,  ZP3,  ZP4  */ z12, z13, z14, z15)

      /* load bf16 input - part 2 */
      "ld1h    z24.h, p5/z, [%[a_bf16_ptr3], #0, MUL VL] \n"
      "ld1h    z25.h, p4/z, [%[a_bf16_ptr3], #1, MUL VL] \n"
      "ld1h    z26.h, p5/z, [%[a_bf16_ptr4], #0, MUL VL] \n"
      "ld1h    z27.h, p4/z, [%[a_bf16_ptr4], #1, MUL VL] \n"

      "add     %[a_bf16_ptr3], %[a_bf16_ptr3], #32 \n"
      "add     %[a_bf16_ptr4], %[a_bf16_ptr4], #32 \n"

      ASM_BLOCK_PREFETCH_PART_2
...
#define LABEL_SKIP_PRF_1 "7"
#define LABEL_SKIP_PRF_2 "8"
#define LABEL_SKIP_ACCUMULATE "9"
  ...
  asm volatile(
      ...
      "add     x5,    x2, #4                       \n" // m + 4
      "cmp     x5,    %[M]                         \n"
      "b.tcont " LABEL_SKIP_LD_A2 "f               \n" // if (m + 4) > M, go to label
      "ld1h    z24.h, p5/z, [%[a_bf16_ptr3], #0, MUL VL] \n"
      "ld1h    z25.h, p4/z, [%[a_bf16_ptr3], #1, MUL VL] \n"

      "add     x5,    x2, #6                       \n" // m + 6
      "cmp     x5,    %[M]                         \n"
      "b.tcont " LABEL_SKIP_LD_A2 "f               \n" // if (m + 6) > M, go to label
      "ld1h    z26.h, p5/z, [%[a_bf16_ptr4], #0, MUL VL] \n"
      "ld1h    z27.h, p4/z, [%[a_bf16_ptr4], #1, MUL VL] \n"
      " " LABEL_SKIP_LD_A2 ":\n"
