 ...
 * @file    gemm_kernel_a16w8_m2_fp16.cpp
 */
...
#define LABEL_UPDATE_DQ_PARAM_2 "6"
#define LABEL_SKIP_ACCUMULATE "7"
  ...
  asm volatile(
      ...
      " " LABEL_FOR_LOOP_K ":\n"
      ASM_BLOCK_UPDATE_DQ_PARAM_FP16(/* SRC1, SRC2 */ z10, z11,
                                     /* TMP1, TMP2 */ z8,  z9,
                                     /* SC1, SC2, ZP1, ZP2 */ z4, z5, z6, z7)
      ...
      /* weight u8->bf16 */
      ASM_BLOCK_WEIGHT_U8_TO_FP16_TO_BF16(/* SRC1, SRC2             */ z14, z19,
                                          /* DST1, DST2, DST3, DST4 */ z14, z15, z16, z17,
                                          /* TMP1, TMP2, TMP3, TMP4 */ z14, z15, z16, z17,
                                          /* TMP5, TMP6, TMP7       */ z19, z20, z18,
                                          /* SC1,  SC2,  ZP1,  ZP2  */ z4,  z5,  z6,  z7)
