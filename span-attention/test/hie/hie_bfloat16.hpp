...
struct bfloat16 {
  __Bf16Impl __x;
  static_assert(sizeof(__Bf16Impl) == __BF16_SIZE_INBYTE,
                "invalid __Bf16Impl size");
  ...
  __BF16_DEVICE_FUNC explicit bfloat16(__Bf16Impl v) { __x = v; }
  ...
  __BF16_DEVICE_FUNC bfloat16(float v) { __x = __Bf16Impl::float2bfloat16(v); }

  __BF16_DEVICE_FUNC bfloat16(double v) {
    __x = __Bf16Impl::double2bfloat16(v);
  }

  __BF16_DEVICE_FUNC bfloat16(long long v) { __x = __Bf16Impl::ll2bfloat16(v); }

  __BF16_DEVICE_FUNC bfloat16(unsigned long long v) {
    __x = __Bf16Impl::ull2bfloat16(v);
  }

  __BF16_DEVICE_FUNC bfloat16(long v) { __x = __Bf16Impl::ll2bfloat16(v); }

  __BF16_DEVICE_FUNC bfloat16(unsigned long v) {
    __x = __Bf16Impl::ull2bfloat16(v);
  }

  __BF16_DEVICE_FUNC bfloat16(int v) { __x = __Bf16Impl::int2bfloat16(v); }

  __BF16_DEVICE_FUNC bfloat16(unsigned int v) {
    __x = __Bf16Impl::uint2bfloat16(v);
  }

  __BF16_DEVICE_FUNC bfloat16(short v) { __x = __Bf16Impl::short2bfloat16(v); }
...
class numeric_limits<hie::bfloat16> {
 ...
 public:
  static const bool is_specialized =
      std::numeric_limits<bf16_impl_t>::is_specialized;
  ...
  static const bool has_infinity =
      std::numeric_limits<bf16_impl_t>::has_infinity;
  static const bool has_quiet_NaN =
      std::numeric_limits<bf16_impl_t>::has_quiet_NaN;
  static const bool has_signaling_NaN =
      std::numeric_limits<bf16_impl_t>::has_signaling_NaN;
  static const std::float_denorm_style has_denorm =
      std::numeric_limits<bf16_impl_t>::has_denorm;
  static const bool has_denorm_loss =
      std::numeric_limits<bf16_impl_t>::has_denorm_loss;

  static const bool traps = std::numeric_limits<bf16_impl_t>::traps;

  static const bool tinyness_before =
      std::numeric_limits<bf16_impl_t>::tinyness_before;

  static const std::float_round_style round_style =
      std::numeric_limits<bf16_impl_t>::round_style;
  ...
  static const int max_digits10 =
      std::numeric_limits<bf16_impl_t>::max_digits10;
  ...
  static const int min_exponent =
      std::numeric_limits<bf16_impl_t>::min_exponent;

  /// Smallest normalized representable power of 10.
  static const int min_exponent10 =
      std::numeric_limits<bf16_impl_t>::min_exponent10;

  /// One more than largest exponent
  static const int max_exponent =
      std::numeric_limits<bf16_impl_t>::max_exponent;

  /// Largest finitely representable power of 10.
  static const int max_exponent10 =
      std::numeric_limits<bf16_impl_t>::max_exponent10;
