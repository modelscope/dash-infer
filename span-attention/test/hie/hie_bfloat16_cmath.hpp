...
#define __HIE_CMATH_API_BFBF(func, expr)                      \
  ...
  __hie_buildin::bfloat16 func(__hie_buildin::bfloat16 arg) { \
    return __hie_buildin::bfloat16(                           \
        __hie_buildin::__bf16_cmath_impl::expr(arg.__x));     \
  }

#define __HIE_CMATH_API_BFBFBF(func, expr)                     \
  __CMATH_DEVICE_FUNC __hie_buildin::bfloat16 func(            \
      __hie_buildin::bfloat16 x, __hie_buildin::bfloat16 y) {  \
    return __hie_buildin::bfloat16(                            \
        __hie_buildin::__bf16_cmath_impl::expr(x.__x, y.__x)); \
  }
...
__CMATH_DEVICE_FUNC __hie_buildin::bfloat16 fma_bf16(
    __hie_buildin::bfloat16 x, __hie_buildin::bfloat16 y,
    __hie_buildin::bfloat16 z) {
  return __hie_buildin::bfloat16(
      __hie_buildin::__bf16_cmath_impl::fma(x.__x, y.__x, z.__x));
}
