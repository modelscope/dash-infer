...
run_python_example() {
    ...
    pip install dashinfer -i https://mirrors.aliyun.com/pypi/simple/
...
run_python_example 3.8  2>&1 | tee pypi_test_log_py38.txt
run_python_example 3.9  2>&1 | tee pypi_test_log_py39.txt
run_python_example 3.10 2>&1 | tee pypi_test_log_py310.txt
run_python_example 3.11 2>&1 | tee pypi_test_log_py311.txt
