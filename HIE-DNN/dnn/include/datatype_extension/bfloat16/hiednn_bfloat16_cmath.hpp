 ...
 * @file    hiednn_bfloat16_cmath.hpp
 */

#ifndef DNN_INCLUDE_DATATYPE_EXTENSION_BFLOAT16_HIEDNN_BFLOAT16_CMATH_HPP_
#define DNN_INCLUDE_DATATYPE_EXTENSION_BFLOAT16_HIEDNN_BFLOAT16_CMATH_HPP_

#include "hiednn_bfloat16.hpp"
#include "cppbfloat16_cmath_impl.hpp"
...
__CMATH_DEVICE_FUNC \
__hiednn_buildin::bfloat16 func(__hiednn_buildin::bfloat16 arg) { \
    return __hiednn_buildin::bfloat16( \
            __hiednn_buildin::__bf16_cmath_impl::expr(arg._x)); \
}

#define __HIE_CMATH_API_BFBFBF(func, expr) \
__CMATH_DEVICE_FUNC __hiednn_buildin::bfloat16 \
func(__hiednn_buildin::bfloat16 x, __hiednn_buildin::bfloat16 y) { \
    return __hiednn_buildin::bfloat16( \
            __hiednn_buildin::__bf16_cmath_impl::expr(x._x, y._x)); \
}

#define __HIE_CMATH_API_BBF(func) \
__CMATH_DEVICE_FUNC bool func(::__hiednn_buildin::bfloat16 arg) { \
    return ::__hiednn_buildin::__bf16_cmath_impl::func(arg._x); \
}
...
__CMATH_DEVICE_FUNC __hiednn_buildin::bfloat16
fma_bf16(__hiednn_buildin::bfloat16 x,
        __hiednn_buildin::bfloat16 y, __hiednn_buildin::bfloat16 z) {
    return __hiednn_buildin::bfloat16(
        __hiednn_buildin::__bf16_cmath_impl::fma(x._x, y._x, z._x));
}
...
#endif  // DNN_INCLUDE_DATATYPE_EXTENSION_BFLOAT16_HIEDNN_BFLOAT16_CMATH_HPP_
